...
class WSOOD(RotatedSingleStageDetector):
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(WSOOD, self).__init__(backbone, neck, bbox_head, train_cfg,
    ...
    def forward_train(self,
        ...
        img2 = rotate_crop(img, rot, self.crop_size, padding=self.padding)
