...
data_root = '/data/nas/dataset_share/DOTA1.5/split_ss_dota1_5/'
data = dict(
    train=dict(type='DOTAv15WSOODDataset', pipeline=train_pipeline,
               ann_file=data_root + 'trainval/annfiles/',
               img_prefix=data_root + 'trainval/images/',
               version=angle_version),
    val=dict(type='DOTAv15WSOODDataset', pipeline=test_pipeline,
             ann_file=data_root + 'trainval/annfiles/',
             img_prefix=data_root + 'trainval/images/',
             version=angle_version),
    test=dict(type='DOTAv15WSOODDataset', pipeline=test_pipeline,
